...
slug: Web/API/Window_management/Guides/Using
page-type: guide
sidebar: window-management-api
---

This guide explains how to use the [Window Management API](/en-US/docs/Web/API/Window_management). The example code seen below is taken from our [Multi-window learning environment](https://mdn.github.io/dom-examples/window-management-api/) example (see the [source code](https://github.com/mdn/dom-examples/tree/main/window-management-api)).
