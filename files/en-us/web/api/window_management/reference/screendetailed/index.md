...
slug: Web/API/Window_management/Reference/ScreenDetailed
...
The **`ScreenDetailed`** interface of the [Window Management API](/en-US/docs/Web/API/Window_management) represents detailed information about one specific screen available to the user's device.
