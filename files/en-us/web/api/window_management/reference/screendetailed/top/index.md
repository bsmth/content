...
short-title: top
slug: Web/API/Window_management/Reference/ScreenDetailed/top
...
{{domxref("ScreenDetailed")}} interface is a number representing the y-coordinate (top edge) of the total screen area inside the OS virtual screen arrangement, relative to the [multi-screen origin](/en-US/docs/Web/API/Window_management/Guides/Multi-screen_origin).
