---
title: SVG font-weight attribute
...
The SVG **`font-weight`** attribute refers to the boldness or lightness of the glyphs used to render the text, relative to other fonts in the same font family.
