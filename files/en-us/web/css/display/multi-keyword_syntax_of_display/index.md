...
{{EmbedLiveSample("multi-keyword-flex")}}
...
<p>
  This paragraph has a span <span class="ib">with padding</span> it is an
  inline-block so the padding is contained and pushes the other line boxes away.
</p>
```
