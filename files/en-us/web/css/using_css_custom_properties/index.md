...
> **Note:** The [`@property`](/en-US/docs/Web/CSS/@property) at-rule gives authors the ability to register custom CSS properties that allow for type checking, default values, and properties that do or do not inherit values from their parent elements.
