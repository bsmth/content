...
**Client hints** are a set of [HTTP request headers](/en-US/docs/Web/HTTP/Headers) that a server can proactively request from a client to get information about the device, network, user, and user-agent-specific preferences.
