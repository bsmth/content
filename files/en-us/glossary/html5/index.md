...
Any modern site should use the [HTML doctype](/en-US/docs/MDN/Writing_guidelines/Code_style_guide/HTML#doctype) — this will ensure that you are using the latest version of HTML.
